...
elizaLogger.info("Initial environment state:", {
    OPENAI_MAX_OUTPUT_TOKENS: process.env.OPENAI_MAX_OUTPUT_TOKENS,
    OPENAI_MAX_OUTPUT_TOKENS_TYPE: typeof process.env.OPENAI_MAX_OUTPUT_TOKENS,
});
...
export function loadEnvConfig(): Settings {
    ...
    if (!result.error) {
        elizaLogger.info("Successfully loaded .env file. Current state:", {
            OPENAI_MAX_OUTPUT_TOKENS: process.env.OPENAI_MAX_OUTPUT_TOKENS,
            OPENAI_MAX_OUTPUT_TOKENS_TYPE: typeof process.env.OPENAI_MAX_OUTPUT_TOKENS,
        });
    } else {
