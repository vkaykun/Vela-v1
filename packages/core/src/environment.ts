import { z } from "zod";
import { ModelProviderName, Clients, type IAgentRuntime } from "./types.js";
...
export const envSchema = z.object({
    ...
    // Model configuration
    OPENAI_MAX_OUTPUT_TOKENS: z.string().transform((val) => parseInt(val, 10)),
    OPENAI_MAX_INPUT_TOKENS: z.string().transform((val) => parseInt(val, 10)),
});
