    ...
    implements IDatabaseCacheAdapter
{
    ...
    async beginTransaction(): Promise<void> {
        ...
        // Use withTransaction instead of direct begin since it's not available on PGlite
        await this.withTransaction(async (tx) => {
    ...
    async commitTransaction(): Promise<void> {
        ...
        // Since we're using withTransaction, the commit is handled automatically
    ...
    async rollbackTransaction(): Promise<void> {
        ...
        // Since we're using withTransaction, we can't explicitly rollback
        // The transaction will be rolled back automatically if there's an error
        this.currentTransaction = null;
    }
