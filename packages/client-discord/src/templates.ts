...
# INSTRUCTIONS: Determine if {{agentName}} should respond to the message and participate in the conversation. Do not comment. Just respond with one of these exact words: RESPOND, IGNORE, or STOP.
...
Response options are RESPOND, IGNORE and STOP (without brackets).
...
# INSTRUCTIONS: Choose the option that best describes {{agentName}}'s response to the last message. Ignore messages if they are addressed to someone else. Respond with exactly RESPOND, IGNORE, or STOP - no brackets or other text.
` + shouldRespondFooter;
